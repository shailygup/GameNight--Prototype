...
$img_info["destination_folder"]				= 'Style/Images/'; //Image directory ends with / (slash)
$img_info["thumbnail_destination_folder"]	= 'Style/Images/thumbs/'; //Thumbnail directory ends with / (slash)
...
//echo "isset";
	...
	if($img_info["img_res"]){
		...
		if($resize_image && $generate_thumb){
			...
			// echo "<img src=\"Style/Images/$resize_image\"><br />";
			// echo "<img src=\"Style/Images/thumbs/$generate_thumb\">";
			// print_r($resize_image);
			$um= new UserManager();
			$um->updateProfilePic($theUserName, $resize_image);
